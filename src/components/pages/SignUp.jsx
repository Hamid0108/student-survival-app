...
import { Mail, Lock, User, Loader, AlertCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white mb-2">StudySurvival</h1>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 backdrop-blur">
          {/* Success Message */}
          {success && (
            <div className="flex items-start gap-3 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg mb-6">
              <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-semibold text-emerald-300">Signup successful!</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/50 border border-slate-600 rounded-lg pl-10 pr-4 py-2 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
          ...
          <button
            ...
            disabled={loading || success}
            className="w-full bg-slate-900/50 border border-slate-600 hover:border-slate-500 disabled:opacity-50 text-slate-300 font-semibold py-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
          >
